...
let userID = 'dfb1ce4b-fd13-443c-b354-d82555e3eeef';
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						url.hostname = 'biog.jianxian.love';
						url.protocol = 'https:';
...
function getVLESSConfig(userID, hostName) {
  const wvlessws = `vless://${userID}@jianxian.love:80?encryption=none&security=none&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#${hostName}`;
  const pvlesswstls = `vless://${userID}@jianxian.love:443?encryption=none&security=tls&type=ws&host=${hostName}&sni=${hostName}&fp=random&path=%2F%3Fed%3D2048#${hostName}`;
